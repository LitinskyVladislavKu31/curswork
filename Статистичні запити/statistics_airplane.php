...
// ID літака, за яким проводиться пошук рейсів
$selected_airplane_id = mysqli_real_escape_string($connection, $_POST['airplane']);

// Запит до бази даних для пошуку рейсів, в яких брав участь обраний літак
$sql = "SELECT flight.ID_flight, flight.Number_flight, flight.InputDate, flight.OutputDate,
        ...
        WHERE flight.ID_airplane = '$selected_airplane_id'";
